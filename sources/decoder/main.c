...
void insert_ordered(List *list, Node *node)
{
	...
	if(list->start == NULL)
	{
		// alterando o start da list
		list->start = node;
		//list->size++;

	}
	// pode ser que a list não esteja vazia,
	// mas vamos inserir de forma ordenada
	// tem freq menor que o start da list
...
/*
* text[i] vai virar um número representado em ASCII
*/
...
* eu preciso percorrer o meu dicionário procurando qual o size de cada um desses caracteres
